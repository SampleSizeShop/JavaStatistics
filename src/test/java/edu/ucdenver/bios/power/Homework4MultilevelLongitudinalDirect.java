 ...
 *
 */
public class Homework4MultilevelLongitudinalDirect {

	private static final String DATA_FILE =  "Homework4MultilevelLongitudinalDirect.xml";
	private static final String TITLE = "Test matrices printed by GLIMMPSE for original Homework 4";
    ...
    public void testPower()
    {
        ...
        params.addSampleSize(13);
        // build sigma matrix


        double [][] sigma  ={{16,   9.70168, 8.2115008, 6.9502214} ,
                             {9.70168 ,       16, 8.9255456, 7.5545818} ,
                             {8.2115008, 8.9255456,        16, 8.9255456} ,
                             {6.9502214, 7.5545818, 8.9255456,        16   } };
        ...
        double F3=(1 +(CL3-1)*ICC3)/CL3;
        double SIGSCAL=F1*F2*F3;
        params.addSigmaScale(SIGSCAL);
