...
java -cp "lib/edu.ucdenver.bios.javastatistics-UNKNOWN.jar;thirdparty/junit/4.7/lib/junit-4.7.jar;thirdparty/ApacheCommonsMath/3.0/lib/commons-math3-3.0.jar;thirdparty/jsc/1.0/lib/jsc.jar" org.junit.runner.JUnitCore edu.cudenver.bios.power.test.paper.TestLawANOVA > figure3.out
